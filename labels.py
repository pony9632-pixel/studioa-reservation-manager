...
_FONT_CANDIDATES = [
    ...
    # Linux（雲端伺服器，需安裝 fonts-wqy-zenhei 套件）。
    # 注意：fonts-noto-cjk 是 CFF 外框，reportlab 載不起來，必須用 TrueType 外框的文泉驛。
    ("/usr/share/fonts/truetype/wqy/wqy-zenhei.ttc", True, 0),
]
_FONT_BOLD_CANDIDATES = [
    ...
    ("/Library/Fonts/Arial Unicode MS.ttf", False, 0),
    ("/usr/share/fonts/truetype/wqy/wqy-zenhei.ttc", True, 0),  # 無粗體，用一般體頂替
]
